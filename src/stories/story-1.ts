...
export const story1: Story = {
  ...
  cover: "https://unsplash.com/photos/xyz", // replace with an actual cover image URL from Unsplash
  backgroundImg: "https://unsplash.com/photos/xyz", // replace with an actual background image URL from Unsplash
  location: {

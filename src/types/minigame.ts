...
const solutionsData = [
  { Icon: Home, text: 'Plan ahead for better housing for everyone', color: 'brown', type: [ SolutionType.flood, SolutionType.landslide ] },
  ...
  { Icon: Droplet, text: 'Increased research to identify areas at high risk for landslides', color: 'blue', type: [ SolutionType.landslide ] },
  ...
  { Icon: Droplet, text: 'prioritize effective stormwater management to prevent water overflow', color: 'blue', type: [ SolutionType.flood ] },
